...
from PySide6.QtGui import QColor, QFont, QFontMetrics, QKeyEvent, QPainter, QSyntaxHighlighter, QTextCharFormat, QTextCursor
...
COMPOSER_MENTION_POPUP_MIN_WIDTH = 500
